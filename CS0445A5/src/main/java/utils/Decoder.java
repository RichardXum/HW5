...
public class Decoder {
    ...
    public Decoder() {
        ...
        root.getLeft().getRight().setRight(new BinaryTreeNode<String>("w"));
    ...
    private String decodeR(BinaryTreeNode<String> n, String m) {
        ...
        if (n!=null) {
            if (m.length()==0){
                ...
                m = m.substring(1);
                return decodeR(n.getLeft(), m);//  Missing recursion here    
            } else if (m.charAt(0)=='-') {
                m = m.substring(1);
                return decodeR(n.getRight(), m);//  Missing recursion here
            } 
        }
        return str;
    }
